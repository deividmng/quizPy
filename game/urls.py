...
urlpatterns = [
    ...
    path('js_level_2/', views.js_level_2, name='js_level_2'),
    path('python_level_2/', views.python_level_2, name='python_level_2'),
    path('sql_level_2/', views.sql_level_2, name='sql_level_2'),
    path('git_level_2/', views.git_level_2, name='git_level_2'),
